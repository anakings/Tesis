...
withAntennaPlus = false; % Apply propagation loss (true) or not (false)
...
if withAntennaPlus
    folder = strcat('/', antenna_name, '/data', '/data_corr_antenna_plus/');
else
    folder = strcat('/', antenna_name, '/data', '/data_corr/');
end
...
for antennasNumber = 10:2:16
    ...
    correlation_matrix_data(name, antennasNumber, antenna_type, fc, lambda, ...
